...
<head>
    ...
    <style>
        ...
        .header {
            text-align: center;
            background-color: #1976d2; /* Azul forte para o cabeçalho */
            color: #fff;
            padding: 15px 0;
            margin-bottom: 20px;
            border-radius: 8px;
        ...
        table, th, td {
            border: 1px solid #1976d2; /* Bordas azuis */
        }
        ...
        th {
            background-color: #e3f2fd; /* Azul claro para o cabeçalho da tabela */
        }

        .btn-excluir {
            background-color: #0288d1; /* Azul para o botão de excluir */
            color: white;
            padding: 5px 10px;
            border: none;
            border-radius: 5px;
        ...
        .btn-excluir:hover {
            background-color: #0277bd; /* Azul mais escuro para o hover */
        }
    </style>
</head>
<body>
